...
/**
 * TODO
 * @author Create by 鲁超 on 2022/8/4 11:14
 *----------Dragon be here!----------/
 *       ┌─┐      ┌─┐
 *     ┌─┘─┴──────┘─┴─┐
 *     │              │
...
fun BaseAct.findPreAct(): BaseAct? {
...
fun Activity.setFontScale() {
    resources.configuration.fontScale = if (MK.decodeBool(MKKeys.KEY_LARGE_TEXT)) 1.2f else 1.0F
}